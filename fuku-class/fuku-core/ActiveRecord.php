<?php
/**
 * ActiveRecord.php is model class
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * ActiveRecord is model class
 *
 * An example of a ActiveRecord is:
 *
 * <code>
...
abstract class ActiveRecord
{
   ...
   public function __construct($id, $use_cache='memcache')
   {
      ...
      $temp_table_name = get_class($this);
      ...
      }// end if ($this->use_cache=='memcache' && ENABLE_CACHE)
   ...
   public function setMemcacheAccess()
   {
      ...
      $this->memcache_obj = MemcacheAccess::getInstance(
          KEY_PREFIX.$this->table_name.'_'.$this->id
      );
