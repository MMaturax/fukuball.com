<?php
/**
 * JiebaViewController.php is the controller
 * to dispatch jieba actions with jieba view
 *
 * PHP version 5
 *
 * @category PHP
      ...
      implements RESTfulInterface
{
   ...
   public function restPost($segments)
   {
      ...
      case 'jieba-process':
         ...
         if (empty($ckip_process_result_term)) {
            echo "<h2>目前無法連上中研院斷詞系統，請聯繫 morris@iis.sinica.edu.tw</h2>";
         } else {
   ...
   public function restGet($segments)
   {
      ...
      default:
         ...
         $meta_type = "jieba";
         $page_title = 'Jieba 線上中文斷詞 | 線上中文斷詞首頁';
         $jieba_active = 'active';
         $yield_path = '/fuku-view-page/jieba-home.php';
         require_once SITE_ROOT.'/fuku-view-layout/jieba-page-layout.php';
