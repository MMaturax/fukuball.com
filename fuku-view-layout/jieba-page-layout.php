<?php
/**
 * jieba-page-layout.php is the jieba page layout
 *
 * PHP version 5
 *
 * @category PHP
...
<html lang='en' xmlns:fb='https://www.facebook.com/2008/fbml' xmlns:og='http://ogp.me/ns#'>
   <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
      ...
      ?>
      <link href="/public/stylesheet/jieba.css?v=0.0.12" rel="stylesheet">
      <?php
   ...
   <body>
      <?php
      include_once SITE_ROOT."/fuku-view-component/header/jieba-header.php";
      ?>
      ...
      <?php
      include_once SITE_ROOT."/fuku-view-component/footer/jieba-footer.php";
